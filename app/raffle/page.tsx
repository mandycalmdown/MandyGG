  ...
  return (
    <div style={{ minHeight: "100vh", background: PAGE_BG, color: "#fff", fontFamily: "var(--font-poppins), sans-serif" }}>
      ...
      <div style={{ textAlign: "center", padding: "2.5rem 1rem 0" }}>
        <h1 style={{ fontWeight: 900, fontSize: "clamp(1.8rem, 6vw, 3.5rem)", textTransform: "uppercase", letterSpacing: "0.04em", color: "#fff", lineHeight: 1.1, marginBottom: "0.5rem" }}>
          <span style={{ color: LIME }}>$250</span> WEEKLY RAFFLE
        </h1>
        <p style={{ fontSize: "0.75rem", fontWeight: 700, letterSpacing: "0.18em", color: "rgba(255,255,255,0.4)", textTransform: "uppercase" }}>
