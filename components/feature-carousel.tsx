...
const CARDS = [
  ...
  },
  {
    ...
    btn: { label: "DETAILS", href: "poker-modal", ext: false },
  },
  {
    ...
    btn: { label: "JOIN TELEGRAM", href: "https://t.me/mandyggchat", ext: true },
  },
] as const;

const TOTAL = CARDS.length;

function HoloButton({ href, ext, onClick, children }: { href: string; ext: boolean; onClick?: () => void; children: React.ReactNode }) {
  const inner = (
    <>
            ...
            >
              ...
              >
                ...
                <HoloButton 
                  href={c.btn.href} 
                  ext={c.btn.ext}
                  onClick={c.btn.href === "poker-modal" ? () => setPokerModalOpen(true) : undefined}
                >
                  {c.btn.label}
                </HoloButton>
              </article>
